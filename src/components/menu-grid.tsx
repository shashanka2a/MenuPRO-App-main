      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service) => (
            <Card key={service.id} className="bg-white rounded-lg shadow-md border-0 border-t-[2px] border-t-[#FF6B00] overflow-hidden">
              <CardContent className="p-8">
                <div className="w-12 h-12 bg-[#FF6B00] rounded-lg flex items-center justify-center mb-6">
